...
bc. 
p2admin -application org.eclipselabs.equinox.p2.composite.repository -location repositoryURI [-add repository-list] [-remove repository-list] [-repositoryName name] [-validate] [-failOnExists] [-compressed]
