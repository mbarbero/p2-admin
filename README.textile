...
This eclipse headless application (*less than 20MB*) provides you the following 14 tools to manage your p2 repositories:
...
bc. 
eclipse -application org.eclipselabs.equinox.p2.composite.repository -location repositoryURI [-add repository-list] [-remove repository-list] [-validate] [-failOnExists] [-compressed]
